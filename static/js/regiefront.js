    ...
    success:function(data){
            ...
            allTeammembers.crewMembers.forEach(einzelner => {
                ...
                //console.log(einzelner, 'einzelner');
                    ...
                    let editbutton = $('<td>').append('<button>').attr({"class":"btn btn-primary editUser"}).html('edit').appendTo($tr);
                    let deletebtn = $('<td>').append('<button>').attr({"class":"btn btn-danger delUser"}).html('delete').appendTo($tr);
                    editbutton.hide();
                    deletebtn.hide();
                    ...
                    $('.delUser').on('click', function(){
                        ...
                        console.log(id)
                        let tableofUser = $(id).parent()
                        console.log(tableofUser, 'table')
                        $.ajax({
                            url:'regie/crewmemberlist/ '+ id,
                            method: 'DELETE',
